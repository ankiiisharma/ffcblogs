  ...
  return (
      ...
      <div className="flex justify-center mb-2">
        <div className="max-w-xs sm:max-w-md md:max-w-xl">
          <img src={blog.imageUrl} className="rounded-lg border border-slate-400 mt-[20px]" />
          <h1 className="font-semibold text-[18px] flex items-center mt-1 mb-3"> <FaPenNib className="mr-1" />  {blog.author.name} </h1>
